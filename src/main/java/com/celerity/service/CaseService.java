...
public class CaseService {
	...
	public Long addEnrollee(@PathParam("caseId") Long caseId, CensusPerson enrollee) {
		SgsCase sgsCase = DataSource.cases.get(caseId);
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Long addDependent(@PathParam("enrolleeId") Long enrolleeId, CensusPerson dependent) {
